...
statements:{
    fontSize:"10px", marginBottom:"0px", fontWeight:"400"
},
bannerCtn:{
    display:'flex', background:"#ffc438", color:"white", justifyContent:"center", height:"200px", alignItems:"center", fontFamily:"roboto"
}
});
...
<Card style={{height:"179px", marginRight:"3rem", borderRadius:"30px", border:"1px solid #e6fbff"}}>
...
<Card style={{height:"179px", marginTop:"1rem", marginRight:"3rem", borderRadius:"30px", border:"1px solid #e6fbff"}}>
<Box style={{display:"flex"}}>
    <div style={{height:"179px", width:"100px",display:"flex", justifyContent:"center", alignItems:"center"}}>
        <div>
    ...
    <label className={classes.statements}>WEST GARDA HOTEL, Via Prais, Padhenge sul</label>
    <label className={classes.statements}>lorem ipsum odor dfsfds fdsfds sdffddsf</label>
    <label className={classes.statements}>lorem ipsum odor dfsfds fdsfds sdffddsf</label>
    <label className={classes.statements}>lorem ipsum odor dfsfds fdsfds sdffddsf</label>
    </div>
    </Box>
...
<label style={{fontWeight:"500", fontSize:"20px", }}>Call the restaurant at 3555549</label>
<a href="https://www.google.com" style={{marginLeft:"10px", marginBottom:"0.5rem", color:"white"}}><u>Check our dedicated section</u></a>
...
<Grid item md={7} lg={7}>
    ...
    <Grid item md={6} lg={6} style={{display:"flex", justifyContent:"center", flexDirection:"column"}}>

   
        <div style={{display:"flex", justifyContent:"flex-start", fontSize:"2rem", fontWeight:"700"}}>
            <label>Follow us</label>
        </div>
        <div style={{display:"flex", justifyContent:"flex-start", flexDirection:"column"}}>
            <label style={{display:"flex"}}>lorem ipsum dolor sitt amet, consteurer sadipir elitr, sed</label>
            <label style={{display:"flex"}}>lorem ipsum dolor sitt amet, consteurer sadipir elitr, sed</label>
            <label style={{display:"flex"}}>lorem ipsum dolor sitt amet, consteurer sadipir elitr, sed</label>
        </div>
        <div style={{display:"flex", justifyContent:"space-between"}}>
            ...
            <div style={{marginRight:"40px"}}>
                <Button style={{border:"1px solid #ffc438", borderRadius:"30px", color:"#ffc438", width:"200px" }}>Jump to Home</Button>
            </div>
        </div>
...
<Grid item md={5} lg={5}>
    <div style={{marginBottom:"60px"}}>
        <img src="https://images.unsplash.com/photo-1563986768494-4dee2763ff3f?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8ZGlnaXRhbCUyMG1hcmtldGluZ3xlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&w=1000&q=80" alt="man using laptop" />
        </div>
</Grid>
