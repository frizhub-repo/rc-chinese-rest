    ...
    <section className="text-gray-700 body-font mb-4 ">
      <div className="h-80 mx-auto flex px-24 py-16 md:flex-row flex-col ">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font font-old sm:text-4xl text-3xl mb-4 font-medium text-gray-900 text-left">
            Make your party
            <br className="hidden lg:inline-block" />
            with delicious dishes
          </h1>
          <p className="mb-8 leading-relaxed text-xs text-gray-500 font-weight-bold text-left">
          ...
          <div className="flex justify-content-end w-full">
            <button className="mr-0  text-gray-900 bg-yellow-400 border-0 py-2 px-6 focus:outline-none  rounded-pill font-weight-bold text-sm">
              Order now
            </button>
          </div>
        </div>
      ...
      <div
        className="h-72  px-0 mt-12 w-full mb-0"
        style={{ background: `url(${Desk}) center center` }}
      >
        <div className="flex px-44 justify-content-between align-items-end mt-8 mb-12">
          <div className="h-36 w-36 flex align-items-center  mr-4 justify-content-center rounded-circle border-4 border-white bg-black">
            <h1 className="text-white text-3xl text-center font-weight-bold">
              25% off
            </h1>
          </div>
      ...
      <div className=" h-72 flex justify-content-center  bg-yellow-300 py-18 ">
        <div className="w-full px-36">
          <div className="flex justify-content-around items-end mb-10 ">
            <div>
              <h1 className="text-white text-left text-6xl mt-28  font-weight-bold">
                Sashimi mix
              </h1>
            ...
            <button className="mr-0 ml-4 h-12 my-2 px-8 text-white bg-black border-0  focus:outline-none font-weight-bold rounded-pill text-sm">
              Order now
            </button>
          </div>
        </div>
      ...
      <section className="  flex mt-72 "></section>
    </section>
  );
}
