    ...
    return(
        <section className='w-full ml-4 p-4 border border-gray-300'>
            <div className='mb-3'>
                ...
                <button className='w-full rounded-pill  bg-yellow-500 text-white text-center text-xs py-2 mb-4  font-weight-light'>ORDER NOW</button>
                <p className='text-xs text-center text-indigo-500 '>If you have any food allergy please click here</p>

            </div>
            <div>

                <p className='text-black text-center p-2 text-xs border-2 border-red-500 rounded-pill  mt-1'>Home delivery {total}</p>
